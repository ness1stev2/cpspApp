...
import { ViewportScroller, NgFor, NgStyle, AsyncPipe, SlicePipe } from '@angular/common';
...
@Component({
    ...
    standalone: true,
    imports: [PortadaComponent, NgFor, NgStyle, RouterLink, AsyncPipe, SlicePipe]
})
export class CreditosComponent implements OnInit {
  ...
  constructor(private router: Router, private viewportScroller: ViewportScroller, private creditoService : CpspService) {}
  ngOnInit(): void {
